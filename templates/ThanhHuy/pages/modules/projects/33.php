...
<html lang="en">
    <head>
        ...
        <title>Module - Sidebar left e-commerce</title>
        ...
        $less = new lessc;
        $less->compileFile('../../less/projects/33.less', '../../css/projects/33.css');
        ?>
        <link rel="stylesheet" href="../../css/projects/33.css">
        <script src="../../js/projects/33/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/projects/33/bootstrap.min.js" type="text/javascript"></script>
    </head>
