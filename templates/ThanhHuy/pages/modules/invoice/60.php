...
<html lang="en">
    <head>
        ...
        $less = new lessc;
        $less->compileFile('../../less/invoice/60.less', '../../css/invoice/60.css');
        ?>
        <link rel="stylesheet" href="../../css/invoice/60.css">
        <script src="../../js/invoice/60/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/invoice/60/bootstrap.min.js" type="text/javascript"></script>
        <script src="../../js/invoice/60/collapse-close.js" type="text/javascript"></script>
    </head>
