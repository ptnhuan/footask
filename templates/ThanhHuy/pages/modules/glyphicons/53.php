...
<html lang="en">
    <head>
        ...
        $less = new lessc;
        $less->compileFile('../../less/glyphicons/53.less', '../../css/glyphicons/53.css');
        ?>
        <link rel="stylesheet" href="../../css/glyphicons/53.css">
        <script src="../../js/glyphicons/53/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/glyphicons/53/bootstrap.min.js" type="text/javascript"></script>
    </head>
