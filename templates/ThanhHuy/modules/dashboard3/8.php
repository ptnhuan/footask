...
<html lang="en">
    <head>
        ...
        <script src="../../js/dashboard3/8/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/dashboard3/8/bootstrap.min.js" type="text/javascript"></script>
                        ...
                        <div class="menu-list">
                            <ul id="menu-content" class="menu-content collapse out">
                                ...
                                <ul class="sub-menu collapse" id="home">
                                    ...
                                    <li class="active"><a href="#">&#8226; Dashboard3</a></li>
                                </ul>
