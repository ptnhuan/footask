...
<html lang="en">
    <head>
        ...
        <script src="../../js/e-commerce/29/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/e-commerce/29/bootstrap.min.js" type="text/javascript"></script>
    </head>
                        ...
                        <div class="menu-list">
                            <ul id="menu-content" class="menu-content collapse out">
                                ...
                                <ul class="sub-menu collapse" id="pages">
                                    <li class="active"><a href="#">&#8226; E-commerce</a></li>
