...
<html lang="en">
    <head>
        ...
        $less = new lessc;
        $less->compileFile('../../less/invoice/58.less', '../../css/invoice/58.css');
        ?>
        <link rel="stylesheet" href="../../css/invoice/58.css">
        <script src="../../js/invoice/58/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/invoice/58/bootstrap.min.js" type="text/javascript"></script>
    </head>
