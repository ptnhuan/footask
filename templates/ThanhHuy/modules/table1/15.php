...
<html lang="en">
    <head>
        ...
        <title>Module - Sidebar left table1</title>
        ...
        $less = new lessc;
        $less->compileFile('../../less/table1/15.less', '../../css/table1/15.css');
        ?>
        <link rel="stylesheet" href="../../css/table1/15.css">
        <script src="../../js/table1/15/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/table1/15/bootstrap.min.js" type="text/javascript"></script>
    </head>
