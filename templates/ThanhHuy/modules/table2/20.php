...
<html lang="en">
    <head>
        ...
        <title>Module - Sidebar left table2</title>
        ...
        $less = new lessc;
        $less->compileFile('../../less/table2/20.less', '../../css/table2/20.css');
        ?>
        <link rel="stylesheet" href="../../css/table2/20.css">
        <script src="../../js/table2/20/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/table2/20/bootstrap.min.js" type="text/javascript"></script>
    </head>
                        ...
                        <div class="menu-list">
                            <ul id="menu-content" class="menu-content collapse out">
                                ...
                                <ul class="sub-menu collapse" id="tables">
                                    ...
                                    <li class="active"><a href="#">&#8226; Table Dynamic</a></li>
                                </ul>
