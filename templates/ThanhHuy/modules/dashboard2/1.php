...
<html lang="en">
    <head>
        ...
        <title>Module - Slide bar left dashboard2 </title>
        ...
        $less = new lessc;
        $less->compileFile('../../less/dashboard2/1.less', '../../css/dashboard2/1.css');
        ?>
        <link href="../../css/dashboard2/1.css" rel="stylesheet" type="text/css"/>
        <script src="../../js/dashboard2/1/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="../../js/dashboard2/1/bootstrap.min.js" type="text/javascript"></script>
    </head>
                        ...
                        <div class="menu-list">
                            <ul id="menu-content" class="menu-content collapse out">
                                ...
                                <ul class="sub-menu collapse" id="home">
                                    ...
                                    <li class="active"><a href="#">&#8226; Dashboard2</a></li>
