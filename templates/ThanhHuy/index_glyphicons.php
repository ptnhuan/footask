...
<html lang="en">
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/glyphicons/type-f-12.less', 'css/glyphicons/type-f-12.css');
        ?>
        <link rel="stylesheet" href="css/glyphicons/type-f-12.css">
        <script src="js/glyphicons/jquery-2.1.4.min.js" type="text/javascript"></script>
        <script src="js/glyphicons/bootstrap.min.js" type="text/javascript"></script>
        <script src="js/glyphicons/back-to-top.js" type="text/javascript"></script>
        <script src="js/glyphicons/flexible-menu.js" type="text/javascript"></script>
        <script src="js/glyphicons/collapse-close.js" type="text/javascript"></script>
    </head>
                        ...
                        <div class="menu-list">
                            ...
                            <ul id="menu-content" class="menu-content collapse out">
                                ...
                                <ul class="sub-menu collapse" id="uie">
                                    ...
                                    <li class="active"><a href="index_glyphicons.php">&#8226; Glyphicons</a></li>
                            ...
                            <ul>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="#">&#8226; Typography</a></li>
                                        <li><a href="#">&#8226; Icons</a></li>
                                        <li  class="active"><a href="#">&#8226; Glyphicons</a></li>
                                        <li><a href="#">&#8226; Widgets</a></li>
                                        <li><a href="#">&#8226; Invoice</a></li>
                                        <li><a href="#">&#8226; Inbox</a></li>
                                        <li><a href="#">&#8226; Calendar</a></li>
