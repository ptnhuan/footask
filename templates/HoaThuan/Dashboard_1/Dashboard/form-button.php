...
<html>
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less/form-button.less', 'css/form-button.css');
        ?>
        <link href="css/form-button.css" rel="stylesheet" type="text/css"/>
        <script src="js/jquery.min.js" type="text/javascript"></script>
        <script src="js/bootstrap.min.js" type="text/javascript"></script>
        <script src="js/flexible-menu.js" type="text/javascript"></script>
        <script src="js/close1.js" type="text/javascript"></script>
        <script src="js/close2.js" type="text/javascript"></script>
        <script src="js/close3.js" type="text/javascript"></script>
        <script src="js/close4.js" type="text/javascript"></script>
        <script src="js/close5.js" type="text/javascript"></script>
        <script src="js/close6.js" type="text/javascript"></script>
        <script src="js/close7.js" type="text/javascript"></script>
    ...
    <body>
        <div class="type-25">
            <div class="container-fuild dasboard">
                <div class="row left">
                    ...
                    <div class="col-md-10 col-xs-12 col-sm-12 right-col">
