...
<html>
    <head>
        ...
        $less = new lessc;
        $less->compileFile('less//form-validation.less', 'css/form-validation.css');
        ?>
                            ...
                            <div class="x_panel">
                                ...
                                <div id="collapse1" class="panel-collapse">
                                    ...
                                    <form class="form-horizontal" novalidate="">
                                        ...
                                        <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="general-form.php">form page</a>
                                        </p>
